    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            res = _context.sent;
            console.log("From Login.js Email : ".concat(email, "  Password: ").concat(password));
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic3VtYW5rdW1hcnNpbmdoMSIsImEiOiJja2djczR4djgwdTB1MzBzNXE3N2tiZnhlIn0.Z8KbM4_794LSZf_VAYQ7dQ';
...
var stripe = Stripe('pk_test_51HkqyVEQVhqPzS3qZYAxknHkxS1LETg0kBebbjCwRmlE3eRmUrkEc1b6h7bVDphYloaTkBiEc1Dd93MQL1etTy3P00fRiQwnWs');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return axios("http://127.0.0.1:3000/api/v1/booking/checkout-session/".concat(tourId));
